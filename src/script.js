...
const ScrollComponent =({kittens,puppies})=>{
  ...
  return (
    <div className="kitten-img">
      {kittens.map((kitten)=> <img src={kitten} className="kitten-images"/>)}
...
const LayoutComponent =({kittens,puppies})=>{
  return (
   <ScrollComponent kittens={kittens} puppies={puppies}/>
)
    }
...
const App = () => {
  ...
  return <LayoutComponent kittens={kittens} puppies={puppies}/>
}
